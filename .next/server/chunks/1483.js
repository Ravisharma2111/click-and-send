...
/* harmony import */ var _subscription_OTPVerification__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(9042);
...
const CardPaymentForm = ({ paymentDetails, setShowPayment })=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        if (Object.keys(errors).length === 0) {
            ...
            try {
                const CustomerResponse = await _utils_axios__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z.post(`api/auth/payment/customer-invoice-payment`, customerInitialValues);
